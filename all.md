...
![オープンランドスケープマップ](./3/img/3-2-5.png).
...
![オープンパブリックトランスポートマップ](./3/img/3-2-7.png).
...
![openlayers_plugin](./3/img/3-2-8.png).
...
![プラグイン](./appendix1/img/appendix1-6-1.png).

追加後に、プラグインをクリックすると

![プラグイン](./appendix1/img/appendix1-6-2.png).
...
![プラグイン](./appendix1/img/appendix1-6-3.png).
...
![プラグイン](./appendix1/img/appendix1-6-4.png).

画面中段にある、ご使用ガイドをクリックしてください。

![プラグイン](./appendix1/img/appendix1-6-5.png).
...
![プラグイン](./appendix1/img/appendix1-6-6.png).

![プラグイン](./appendix1/img/appendix1-6-7.png).

新規ボタンをクリックして、新しいWMSコネクションの作成ウィンドウが開いたら、以下のように記入してください。

![プラグイン](./appendix1/img/appendix1-6-8.png).
...
![プラグイン](./appendix1/img/appendix1-6-9.png).

下図のように表示されることが確認できるかと思います。

![プラグイン](./appendix1/img/appendix1-6-10.png).
