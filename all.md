...
```
![donuts_polygon](2/img/2-2-4.png)
...
![OSMF](./2/img/2-2-8-2.png)

- OSMFJ
http://www.osmf.jp/home

![OSMF_Japan](./2/img/2-2-8-3a.png)

![OSM_Japan](./2/img/2-2-8-3.png)
...
![プラグイン1](./3/img/3-2-1.png).

追加後に、【Web(W)】をクリックします。

![プラグイン2](./3/img/3-2-2.png).
...
![openlayers_plugin](./3/img/3-2-12.png).
...
![openlayers_plugin](./3/img/chiriin_icon.png).
...
![openlayers_plugin](./3/img/3-2-13.png).
...
![openlayers_plugin](./3/img/3-2-14.png).

![openlayers_plugin](./3/img/3-2-15.png).

![openlayers_plugin](./3/img/3-2-16.png).
...
〈地図の単位ピクセルでのラスタ解像度〉を選択し、「水平」「垂直」の欄にメッシュ間隔を入力します。10mメッシュのデータであれば0.4秒間隔なので（Column「10mメッシュは10mではない？」を参照）、単位を度に変換した値0.00011111を、5mメッシュのデータであれば0.2秒間隔なので、単位を度に変換した値0.00005556を入力します。『OK』ボタンを押すとGeoTIFF形式のグリッドデータに変換されます。
...
![国土数値情報ダウンロードサービス](4/img/4-4-1.png)
...
使用に際しては、地図の閲覧回数や図形の数により有料プランになりますので注意が必要です。基本的な地図を作成して公開する分には無料で使用することができます。とても簡単にデータを公開できるため注目されていますので、一度試してみることをおすすめします。
