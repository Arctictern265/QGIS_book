...
![QGISホームページ](a/img/appendix1-1-1.png).
...
![QGISに貢献しよう](a/img/appendix1-1-2.png).
...
![QGIS起動画面](a/img/appendix1-3-1.png)
...
![CRS設定画面](a/img/appendix1-4-1.png)
...
![CRS指定画面](a/img/appendix1-4-2.png)
...
としましょう。
![プラグインの削除](./a/img/appendix1-5-2.png).
...
![レイヤメニュー](a/img/appendix1-8-1.png)
...
![ラスタレイヤ単バンドグレープロパティ](a/img/appendix1-8-2.png)
...
![グレースケール画像の設定例](a/img/appendix1-8-3.png)
...
![ラスタレイヤマルチバンドカラープロパティ](a/img/appendix1-8-4.png)
...
![疑似カラー画像設定画面](a/img/appendix1-8-5.png)
...
![疑似カラー画像線形補間](a/img/appendix1-8-6.png)

〔色の補間〕で”離散的”を選択した場合は各値の間を補間せず、すべて同じ色に設定するので、適用結果は段彩図のようになります。

![疑似カラー画像離散的](a/img/appendix1-8-7.png)
...
![疑似カラー画像厳密](a/img/appendix1-8-8.png)
...
![パレットカラープロパティ](a/img/appendix1-8-9.png)

値に対応する色は個別に設定することができます。

下図は土地被覆分類結果画像にパレットカラーを適用した例です。

![パレットカラー適用例](a/img/appendix1-8-10.png)
...
![シンボルプロパティ](a/img/appendix1-8-11.png)
...
![star2シンボル](a/img/appendix1-8-12.png)
...
![マーカー編集画面](a/img/appendix1-8-13.png)
...
![シンプルラインマーカー設定画面](a/img/appendix1-8-18.png)

 - マーカーライン

マーカーラインとは線を構成するポイントマーカーを指定するものです。ポイントマーカーは点レイヤのものと同じです。マーカーの間隔と回転を定義することができます。

![マーカーラインマーカー設定画面](a/img/appendix1-8-19.png)
...
![アウトラインマーカーライン](a/img/appendix1-8-26.png)

 - アウトラインシンプルライン

枠線をシンプルラインマーカーで描画するシンボルレイヤタイプです。シンプル塗りつぶしで塗りつぶしタイプに”ブラシなし”を指定した場合と同じです。

![アウトラインシンプルライン](a/img/appendix1-8-27.png)
...
![分類モード](a/img/appendix1-8-28.png)
...
![段階分けモード](a/img/appendix1-8-29.png)
...
![ルールモード](a/img/appendix1-8-30.png)

このモードを選択した時にはルールはまだ一つもない状態です。ルールを追加するには下の『＋』ボタンを押します。

![ルールプロパティ](a/img/appendix1-8-31.png)
...
![点の移動モード](a/img/appendix1-8-32.png)
...
![ノードの移動](./a/img/appendix1-9-5.png)
...
![ハイライト表示](./a/img/appendix1-9-6.png)
...
![ボロノイ結果](a/img/appendix1-11-1.png)
