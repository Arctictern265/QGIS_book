...
図:http://portal.cyberjapan.jp/help/image/tileNum.png
（あとで画像を作り直すこと！）
...
図:appendix1/img/appendix1-1-1.png.
...
図:appendix1/img/appendix1-1-2.png.
...
図:appendix1/img/appendix1-2-2.png

http://trac.osgeo.org/osgeo4w/wiki/OSGeo4W_jp
図:appendix1/img/appendix1-2-1.png

今回は、QGIS Standalone Installerを使用したインストールを紹介します。

インストーラーをダウンロードすると、QGISロゴのアイコンで象徴される実行ファイルが表示されるかと思います。
<div align="left">図:appendix1/img/installer.png</div>

このファイルを実行してください。

図:appendix1/img/appendix1-2-3.png

セットアップウィザードが開いたら、次へをクリックしてください。

図:appendix1/img/appendix1-2-4.png

契約書の全ての条件に同意するならば、同意するをクリックしてください。

図:appendix1/img/appendix1-2-5.png
...
図:appendix1/img/appendix1-3-1.png
...
図:appendix1/img/appendix1-4-1.png
...
図:appendix1/img/appendix1-4-2.png
...
図:./appendix1/img/appendix1-5-1.png.
...
としましょう。
図:./appendix1/img/appendix1-5-2.png.
...
図:./appendix1/img/appendix1-6-1.png.

追加後に、プラグインをクリックすると

図:./appendix1/img/appendix1-6-2.png.
...
図:./appendix1/img/appendix1-6-3.png.
...
図:./appendix1/img/appendix1-6-4.png.

画面中段にある、ご使用ガイドをクリックしてください。

図:./appendix1/img/appendix1-6-5.png.
...
図:./appendix1/img/appendix1-6-6.png.

図:./appendix1/img/appendix1-6-7.png.

新規ボタンをクリックして、新しいWMSコネクションの作成ウィンドウが開いたら、以下のように記入してください。

図:./appendix1/img/appendix1-6-8.png.
...
図:./appendix1/img/appendix1-6-9.png.

下図のように表示されることが確認できるかと思います。

図:./appendix1/img/appendix1-6-10.png.
...
図:./appendix1/img/appendix1-7-1.png.
...
図:appendix1/img/appendix1-8-1.png
...
図:appendix1/img/appendix1-8-2.png
...
図:appendix1/img/appendix1-8-3.png
...
図:appendix1/img/appendix1-8-4.png
...
図:appendix1/img/appendix1-8-5.png
...
図:appendix1/img/appendix1-8-6.png

〔色の補間〕で”離散的”を選択した場合は各値の間を補間せず、すべて同じ色に設定するので、適用結果は段彩図のようになります。

図:appendix1/img/appendix1-8-7.png
...
図:appendix1/img/appendix1-8-8.png
...
図:appendix1/img/appendix1-8-9.png

値に対応する色は個別に設定することができます。

下図は土地被覆分類結果画像にパレットカラーを適用した例です。

図:appendix1/img/appendix1-8-10.png
...
図:appendix1/img/appendix1-8-11.png
...
図:appendix1/img/appendix1-8-12.png
...
図:appendix1/img/appendix1-8-13.png
...
図:appendix1/img/appendix1-8-28.png
...
図:appendix1/img/appendix1-8-29.png
...
図:appendix1/img/appendix1-8-30.png

このモードを選択した時にはルールはまだ一つもない状態です。ルールを追加するには下の『＋』ボタンを押します。

図:appendix1/img/appendix1-8-31.png
...
図:appendix1/img/appendix1-8-32.png
...
図:appendix1/img/appendix1-8-47.png
...
図:appendix1/img/appendix1-8-52.png
...
図:./appendix1/img/appendix1-9-5.png
...
図:./appendix1/img/appendix1-9-6.png
...
図:./appendix1/img/appendix1-9-7.png
...
図:appendix1/img/appendix1-11-1.png
