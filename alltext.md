...
図:[1/img/1-2-2-1.png](1/img/1-2-2-1.png)
...
図:[1/img/1-2-2-2.png](1/img/1-2-2-2.png)
...
図:[1/img/1-2-2-3.png](1/img/1-2-2-3.png)

図:[1/img/1-2-2-4.png](1/img/1-2-2-4.png)
...
図:[2/img/2-1-2-2.png](2/img/2-1-2-2.png)
...
図:[./2/img/2-2-column1-1.png](./2/img/2-2-column1-1.png)
...
図:[./2/img/2-2-column1-2.png](./2/img/2-2-column1-2.png)

- OSMFJ
http://www.osmf.jp/home

図:[./2/img/2-2-column1-3a.png](./2/img/2-2-column1-3a.png)

図:[./2/img/2-2-column1-3.png](./2/img/2-2-column1-3.png)
...
図:[http://www.cookbook.hlurb.gov.ph/files/images/RasterVector.preview.jpg](http://www.cookbook.hlurb.gov.ph/files/images/RasterVector.preview.jpg)
...
図:[./2/img/2-3-2-11.png](./2/img/2-3-2-11.png)
...
図:[./3/img/3-2-11.png](./3/img/3-2-11.png).
...
図:[./3/img/3-2-17.png](./3/img/3-2-17.png).
...
図:[4/img/4-1-5green.png](4/img/4-1-5green.png).
{緑色枠線内}に
...
図:[4/img/4-1-6-hinan.png](4/img/4-1-6-hinan.png).

テキストボックス内{hinanbasyo}と入力し、『OK』をクリックしてください。

図11 避難場所SVG

図:[4/img/4-1-6-hinanbasyoSVG.png](4/img/4-1-6-hinanbasyoSVG.png).

SVGマーカーのアイコンが変わります。
『hinanbasyo』をクリックして、『OK』をクリックしてください。

図12 ![避難場所MAP]
図:[4/img/4-1-6-hinanbasyoMAP.png](4/img/4-1-6-hinanbasyoMAP.png).
...
図15 鉄道ラインプロパティ定義
図:[4/img/4-1-8-tetsudo.png](4/img/4-1-8-tetsudo.png).

図16 道路と鉄道プロパティ変更後MAP
図:[4/img/4-1-8-lines.png](4/img/4-1-8-lines.png).
...
図25
図:[4/img/4-1-17.png](4/img/4-1-17.png).
図26
図:[4/img/4-1-18.png](4/img/4-1-18.png).

カラムは〔浸水深さ〕を選択して下さい。
基本的に単一の指標を色相別に分解して表示する場合は、単一の色階調を選択してください。今回は、Bluesを選択しました。
図27
図:[4/img/4-1-19.png](4/img/4-1-19.png).

『分類』をクリックすると、図28の様に水深によって色分けされます。
図28
図:[4/img/4-1-20.png](4/img/4-1-20.png).

『OK』をクリックします。
読み込んだ水深のデータが水深別に色分けされ、地図ビューに反映され図29のようになります。

図29
図:[4/img/4-1-21.png](4/img/4-1-21.png).
...
図:[4/img/4-3-23.png](4/img/4-3-23.png)
...
図:[4/img/4-3-24.png](4/img/4-3-24.png)
...
図:[4/img/4-3-25.png](4/img/4-3-25.png)

図:[4/img/4-3-26.png](4/img/4-3-26.png)
...
図:[4/img/4-4-59.png](4/img/4-4-59.png)をクリックすると、テキストボックスが編集できるようになり、その他のオプションを直接指定できるようになります。川の部分のラスタ値を1に指定するためgdal_rasterize のあとに{ -burn 1 }と入力します。そのまま『OK』ボタンを押すとGeoTIFF形式のラスタデータが作成されます。
...
「出力ファイル」を選択した後、「地図の単位ピクセルでのラスタ解像度」を選択して「水平」「垂直」に10と入力します。そのあと、右下の鉛筆図:[4/img/4-4-59.png](4/img/4-4-59.png)ボタンをクリックすると、テキストボックスが編集できるようになり、その他のオプションを直接指定できるようになります。gdal_rasterize のあとに{ -burn 100 }と入力し、畑地の部分が100になるように指定します（それ以外の部分は0）。そのまま『OK』ボタンを押すと解像度が10mのGeoTIFF形式のラスタデータが作成されます。
...
図:[4/img/4-4-55.png](4/img/4-4-55.png)
...
傾斜方位の値に従い色をつけてみましょう。傾斜方位レイヤを右クリックし、「プロパティ」を選択します。[スタイル]タブから「レンダータイプ」を〔単バンド疑似カラー〕に変更します。プラスボタン図:[4/img/4-4-58.png](4/img/4-4-58.png)を押して色と値、ラベルを追加します。値は0～45°と315～360°を東として緑色に、45～135°を北として青色に、135～225°を西として黄色に、225～315°を南として赤色に設定しました。『OK』ボタンを押せば着色された傾斜方位図が表示されます。

図:[4/img/4-4-57.png](4/img/4-4-57.png)
図:[4/img/4-4-56.png](4/img/4-4-56.png)
...
図:[4/img/4-4-44.png](4/img/4-4-44.png)

〈バッファ距離〉を選択し値を{300}と入力します。「出力シェープファイル」を指定し『OK』ボタンを押すと小学校のポイントから300mのバッファーエリアが作成されます。

図:[4/img/4-4-45.png](4/img/4-4-45.png)
図:[4/img/4-4-46.png](4/img/4-4-46.png)
...
図:[4/img/4-4-50.png](4/img/4-4-50.png)
...
図:[4/img/4-4-51.png](4/img/4-4-51.png)

#####スタイルを整える
集計結果をもとにバッファーレイヤにダイアグラム形式のスタイルを設定します。バッファーレイヤを右クリックして「プロパティ」を選択します。[ダイアグラム]タブを選択します。〈ダイアグラムの表示〉にチェックを入れ、「ダイアグラムタイプ」を〔ヒストグラム〕に変更します。[大きさ]タブを選択し、上段の「属性」を〔kp_sum〕に変更し、その横の「大きさ」に{10}と入力します。下段の「利用可能な属性」のリストから"kp_sum"を選択しプラスボタン図:[4/img/4-4-58.png](4/img/4-4-58.png)を押します。『OK』ボタンを押すと、kp_sumの値に従った棒グラフが表示されます。

図:[4/img/4-4-52.png](4/img/4-4-52.png)

図:[4/img/4-4-53.png](4/img/4-4-53.png)
...
図:[4/img/4-4-54.png](4/img/4-4-54.png)
...
図:[5/img/5-2-0-1.png](5/img/5-2-0-1.png)
...
図:[5/img/5-2-0-2.png](5/img/5-2-0-2.png)
...
図:[5/img/5-2-0-4.png](5/img/5-2-0-4.png)
...
図:[5/img/5-2-0-5.png](5/img/5-2-0-5.png)
...
図:[5/img/5-2-0-8.png](5/img/5-2-0-8.png)
...
図:[5/img/5-2-0-9.png](5/img/5-2-0-9.png)
...
図:[./5/img/5-2-gset1.png](./5/img/5-2-gset1.png)

Downlaod Github for Winodws 2.0
(2014年08月30日現在の最新版)
をダウンロードします。

図:[./5/img/5-2-gset2.png](./5/img/5-2-gset2.png)

ダウンロードディレクトリ内にある、GitHubSetup.exeアイコンを起動します。

図:[./5/img/5-2-gset3.png](./5/img/5-2-gset3.png)

『実行』をクリックしてください。

図:[./5/img/5-2-gset4.png](./5/img/5-2-gset4.png)
...
図:[./5/img/5-2-gset5.png](./5/img/5-2-gset5.png)
...
図:[./5/img/5-2-gset6.png](./5/img/5-2-gset6.png)
...
図:[./5/img/5-2-gset7.png](./5/img/5-2-gset7.png)

フォルダーの参照画面が開きます。これはClone先のディレクトリを指定し『OK』を押します。

図:[./5/img/5-2-gset8.png](./5/img/5-2-gset8.png)

指定したディレクトリにCloneされたディレクトリが作成されます。

図:[./5/img/5-2-gset9.png](./5/img/5-2-gset9.png)

参考に5-2冒頭の「データを準備する」(ここに参照ページ差込)で作成したGeoJSONデータを使用します。
GeoJSONデータをディレクトリにペーストしてください。

図:[./5/img/5-2-gset10.png](./5/img/5-2-gset10.png)
...
図:[./5/img/5-2-gset13.png](./5/img/5-2-gset13.png)
...
図:[./5/img/5-2-column3-1.png](./5/img/5-2-column3-1.png)

図:[./5/img/5-2-column3-2.png](./5/img/5-2-column3-2.png)

図:[./5/img/5-2-column3-3.png](./5/img/5-2-column3-3.png)
...
図:[./5/img/5-2-column2-1.png](./5/img/5-2-column2-1.png)

図:[./5/img/5-2-column2-2.png](./5/img/5-2-column2-2.png)
...
図:[appendix1/img/installer.png](appendix1/img/installer.png)
